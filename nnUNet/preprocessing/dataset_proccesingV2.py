...
dataset_path = "E:\\UPM\\TFG_SOFTWARE\\Proyecto\\DataV2\\Original"

new_dataset_path = "E:\\UPM\\TFG_SOFTWARE\\Proyecto\\DataV2\\Dataset212_CholecSeg8k"

path_labels_test = "E:\\UPM\\TFG_SOFTWARE\\Proyecto\\DataV2"
...
for video_folder in os.listdir(dataset_path):
    ...
    for subfolder in os.listdir(video_path):
        ...
        labels = [img for img in os.listdir(subfolder_path) if img.endswith("_endo_watershed_mask.png")]
