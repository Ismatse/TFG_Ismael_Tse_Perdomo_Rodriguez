### test on SIDD ###
!python3 test/test_sidd.py --input_dir ../datasets/denoising/sidd_val/ --result_dir ./results/denoising/SIDD/ \
 --weights ./logs/denoising/SIDD/Uformer_B/models/model_best.pth 
