...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--arch', type=str, default ='Uformer_B',  help='architechture')
        ...
        # args for training
        parser.add_argument('--train_ps', type=int, default=128, help='patch size a of training sample')
        parser.add_argument('--val_ps', type=int, default=128, help='patch size a of validation sample')
        parser.add_argument('--resume', action='store_true', default=False)
        parser.add_argument('--train_dir', type=str, default ='./datasets/SIDD/train',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='./datasets/SIDD/val',  help='dir of validation data')
        ...
        # args for semantic segmentation

        parser.add_argument('--segmentation', action='store_true', default=True, help="wether it's a segmentation problem or not")
