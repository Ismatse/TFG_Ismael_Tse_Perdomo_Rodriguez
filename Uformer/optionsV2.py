...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--val_ps_a', type=int, default=128, help='patch size a of validation sample')
        parser.add_argument('--val_ps_b', type=int, default=128, help='patch size b of validation sample')
